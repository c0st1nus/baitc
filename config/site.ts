    ...
    items: [
      {
        year: '2025',
        type: 'ai' as const,
        title: s(['Meta Llama Accelerator', 'Meta Llama Accelerator', 'Meta Llama Accelerator']),
        tagline: s(['Global AI × local enterprise partnership', 'Глобальный ИИ × местное партнёрство', 'Жаһандық ЖИ × жергілікті серіктестік']),
        description: s([
        ...
        stats: [{ value: 'Meta', label: s(['partner', 'партнёр', 'серіктес']) }, { value: '2025', label: s(['launch', 'запуск', 'іске қосу']) }, { value: '1000+', label: s(['participants', 'участников', 'қатысушы']) }],
        image: 'https://placehold.co/600x400/22c55e/ffffff?text=Meta+Llama+Accelerator',
        partners: ['Meta', 'AI Digital Ministry', 'Astana Innovations', 'NITEC', 'The Steppe']
      },
      {
        year: '2025',
        type: 'blockchain' as const,
        title: s(['Decentrathon 4.0', 'Деценtратон 4.0', 'Decentrathon 4.0']),
        tagline: s(['Largest Web3 hackathon in Central Asia', 'Крупнейший Web3-хакатон в Центральной Азии', 'Орталық Азиядағы ең үлкен Web3 хакатон']),
        description: s([
        ...
        stats: [{ value: '4,800', label: s(['developers', 'разработчиков', 'әзірлеуші']) }, { value: '$50k', label: s(['prize fund', 'призовой фонд', 'жүлде қоры']) }, { value: '20', label: s(['cities', 'городов', 'қала']) }, { value: '370+', label: s(['projects', 'проектов', 'жоба']) }],
        image: 'https://placehold.co/600x400/22c55e/ffffff?text=Decentrathon+4.0',
        partners: ['Astana Hub', 'inDrive', 'Bank CenterCredit', 'Solana', 'Superteam']
      },
      {
        year: '2025',
        type: 'blockchain' as const,
        title: s(['Decentrathon 3.0', 'Деценtратон 3.0', 'Decentrathon 3.0']),
        tagline: s(['Global online expansion', 'Глобальное онлайн-расширение', 'Жаһандық онлайн кеңейту']),
        description: s([
        ...
        stats: [{ value: '18', label: s(['countries', 'стран', 'ел']) }, { value: '$30k', label: s(['prize fund', 'призовой фонд', 'жүлде қоры']) }, { value: '2,780', label: s(['developers', 'разработчиков', 'әзірлеуші']) }, { value: '352', label: s(['projects', 'проектов', 'жоба']) }],
        image: 'https://placehold.co/600x400/22c55e/ffffff?text=Decentrathon+3.0',
        partners: ['Astana Hub', 'Mastercard', 'Kazakhtelecom', 'Activ 5G', 'Grand Mobile']
      },
      {
        year: '2025',
        type: 'ai' as const,
        title: s(['AI Qyzmet', 'AI Qyzmet', 'AI Qyzmet']),
        tagline: s(['AI literacy for government officials', 'ИИ-грамотность для госслужащих', 'Мемлекеттік қызметкерлерге ЖИ сауаттылығы']),
        description: s([
        ...
        badge: s(['FIRST IN CENTRAL EURASIA', 'ПЕРВЫЙ В ЦЕНТРАЛЬНОЙ ЕВРАЗИИ', 'ОРТАЛЫҚ ЕУРАЗИЯДА БІРІНШІ']),
        stats: [{ value: '50,000', label: s(['civil servants', 'госслужащих', 'қызметкер']) }, { value: 'KPMG', label: s(['certified', 'сертификат', 'сертификат']) }, { value: '32', label: s(['video lectures', 'видеолекций', 'бейнедәрістер']) }],
      ...
      },
      {
        ...
        tagline: s(['Expanded to more cities and tracks', 'Расширение на больше городов и треков', 'Көбірек қалалар мен тректерге кеңейтілді']),
        description: s([
        ...
        stats: [{ value: '1,500+', label: s(['developers', 'разработчиков', 'әзірлеуші']) }, { value: '10', label: s(['cities', 'городов', 'қала']) }, { value: '$50k', label: s(['prize fund', 'призовой фонд', 'жүлде қоры']) }],
      ...
      },
      {
        ...
        tagline: s(['Free AI bootcamp for everyone', 'Бесплатный ИИ-буткемп для всех', 'Барлығына тегін ЖИ-буткемп']),
        description: s([
        ...
        stats: [{ value: '3,000+', label: s(['learners', 'учеников', 'оқушы']) }, { value: 'Free', label: s(['access', 'доступ', 'қол жетімділік']) }],
      ...
      },
      {
        ...
        tagline: s(["World's first multi-location Web3 hackathon", 'Первый в мире мультилокационный Web3-хакатон', 'Әлемдегі бірінші мульти-локациялы Web3 хакатон']),
        description: s([
        ...
        stats: [{ value: '800+', label: s(['developers', 'разработчиков', 'әзірлеуші']) }, { value: '5', label: s(['cities', 'городов', 'қала']) }, { value: '$10k', label: s(['prize fund', 'призовой фонд', 'жүлде қоры']) }],
      ...
      },
      {
        year: '2023',
        type: 'blockchain' as const,
        title: s(['BNB Chain Zero2Hero', 'BNB Chain Zero2Hero', 'BNB Chain Zero2Hero']),
        tagline: s(['6-month Web3 builder program', '6-месячная программа Web3', '6 айлық Web3 бағдарламасы']),
        description: s([
        ...
        stats: [{ value: '200', label: s(['builders', 'разработчиков', 'әзірлеуші']) }, { value: '6', label: s(['months', 'месяцев', 'ай']) }],
        image: 'https://placehold.co/600x400/22c55e/ffffff?text=BNB+Chain+Zero2Hero',
        partners: ['BNB Chain']
      },
      {
        year: '2022',
        type: 'blockchain' as const,
        title: s(['University Outreach Program', 'Университетская программа', 'Университеттік бағдарлама']),
        tagline: s(['Blockchain curriculum for 22 universities', 'Блокчейн-программа для 22 университетов', '22 университетке арналған блокчейн бағдарламасы']),
        description: s([
        ...
        image: 'https://placehold.co/600x400/22c55e/ffffff?text=University+Outreach',
        partners: ['Science & Higher Education Ministry', 'Binance', 'BNB Chain']
      }
    ],
  },
